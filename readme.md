...
## Installation
To install probescript, download a zip file from the releases. Unzip the folder, and run the install/install.exe program with admin permissions on windows or sudo/root access on linux. When the installer is done, you might need to restart your computer.
